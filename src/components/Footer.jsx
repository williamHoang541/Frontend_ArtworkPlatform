                            ...
                            <div className='footer-inner'>
                                <div className='footer-content'>
                                    ...
                                    <div className="content">
                                        <p>{desc}</p>
                                        <ul className='lab-ul office-addresses'>
                                            {
                                                addressList.map((val,i)=>(
                                                    <li key={i}>
                                                        <a href="#"><i className={val.iconName}>{val.text}</i></a>
                                                    </li>
                                                ))
                                            }
                                        </ul>
        ...
        <div className='footer-bottom justify-content-center'>
            <div className='container'>
                <div className='section-wrapper'>
                    <p>&copy; 2024 <Link to='/'>Artworks Platform</Link> Design by<a href='/' target='_blank'>Team 3</a></p>
